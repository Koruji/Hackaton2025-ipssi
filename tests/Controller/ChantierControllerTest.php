...
final class ChantierControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'chantier[adresse]' => 'Testing',
            'chantier[debutTravaux]' => 'Testing',
            'chantier[finTravaux]' => 'Testing',
            'chantier[status]' => 'Testing',
            'chantier[employes]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDebutTravaux('My Title');
        $fixture->setFinTravaux('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setDebutTravaux('Value');
        $fixture->setFinTravaux('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'chantier[adresse]' => 'Something New',
            'chantier[debutTravaux]' => 'Something New',
            'chantier[finTravaux]' => 'Something New',
            'chantier[status]' => 'Something New',
            'chantier[employes]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDebutTravaux());
        self::assertSame('Something New', $fixture[0]->getFinTravaux());
