...
#[Route('/chantier_test')]
final class ChantierTestController extends AbstractController
{
    #[Route(name: 'app_chantier_test_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_chantier_test_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_chantier_test_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('chantier_test/new.html.twig', [
            'chantier' => $chantier,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_chantier_test_show', methods: ['GET'])]
    public function show(Chantier $chantier): Response
    {
        return $this->render('chantier_test/show.html.twig', [
            'chantier' => $chantier,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_chantier_test_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Chantier $chantier, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('chantier_test/edit.html.twig', [
            'chantier' => $chantier,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_chantier_test_delete', methods: ['POST'])]
